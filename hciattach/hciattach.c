...
struct uart_t uart[] = {
	...
	/* for use with the old kernels that don't implement sleep enable */
	{ "texas",      0x0000, 0x0000, HCI_UART_LL,   115200, 115200, FLOW_CTL, NULL, texas,    texas2 },
	/* for use with the new kernels that implement sleep enable */
	{ "texas_new",  0x0000, 0x0000, HCI_UART_LL,   115200, 115200, FLOW_CTL, NULL, texas,    NULL   },
